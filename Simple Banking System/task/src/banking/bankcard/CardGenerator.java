...
public class CardGenerator {
    ...
    private static String getCardNumber() {
        ...
        final int checkSum = generateCardNumber(bin, accountIdentifier);
        String cardNumber = "" + bin + accountIdentifier + checkSum;
        return cardNumber;
    }

    private static int generateCardNumber(int bin, int accountIdentifier) {
    ...
    public static boolean checkCardNumber(String cardNumber) {
        ...
        return generateCardNumber(bin, accountIdentifier) == lastDigit;
    }
}
